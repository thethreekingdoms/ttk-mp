...
function init(args) {
    ...
    function createApp() {
        ...
        const { status, error: cloneError } = spawn.sync('git', ['clone', '--depth=1', templateName !== 'omi' ? `https://github.com/jeffycai/kbone-template-${templateName}` : 'https://github.com/omijs/template-kbone', customPrjName || '.'])
